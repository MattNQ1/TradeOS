...
export function EventRow({ event }: EventRowProps) {
    ...
    return (
        <div
            className={`bg-[var(--color-bg-elev-2)] border border-[var(--color-border)] rounded-lg px-3 py-2.5 grid grid-cols-[auto_auto_1fr_auto] gap-x-3 items-center transition-opacity ${past ? "opacity-50" : ""}`}
        >
            {/* Time */}
